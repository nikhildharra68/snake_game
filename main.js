...
class SnakeGame{
    ...
    drawBackground(color="yellow"){
        ...
        //  fillReact(sc,sr,ec,er)
        // sc-startingColumn ,sr-startingRow 
        // ,ec-endingColumn ,er-endingRow 
    }
    ...
    moveSnake(){
        ...
        if(this.foodAvailable && this.foodAvailable.x===head.x 
            &&  head.y===this.foodAvailable.y){
                // make food undefined after snake eat it
                 this.foodAvailable=undefined;
        }else{
            this.snakeCoordinates.shift();
        }
        
        // console.log(head) //last element be snake head
        // this.snakeCoordinates.shift();//keep length of snake
                                      //  same as it moves
